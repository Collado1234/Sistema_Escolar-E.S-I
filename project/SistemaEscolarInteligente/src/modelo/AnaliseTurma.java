 ...
 * @author renna
 */
public class AnaliseTurma extends AnaliseEstatisticaBase implements Interface_AnaliseEstatistica{
    private Turma turma;

    public AnaliseTurma(Turma turma, List<Avaliacao> avaliacoes) {
        super(avaliacoes);
        this.turma = turma;
    }
    ...
    public String gerarRelatorio() {
        ...
        sb.append("=== Relatório da Turma ").append(turma.getNomeTurma()).append(" ===\n");
